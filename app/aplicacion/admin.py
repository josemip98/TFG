...
class ProductoAdmin(admin.ModelAdmin):
      list_display    = ['nombre','marca','tienda','pais','alergenos','aditivos','puntuacion_nova','image_url','image_small_url','calorias','energia','grasa','grasas_saturadas','colesterol','carbohidratos','azucares','fibra','proteinas','sal','sodio','calcio','hierro','puntuacion']
