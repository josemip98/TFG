...
urlpatterns = [
  ...
  url(r'^modificar_producto/$', views.modificar_producto, name='modificar_producto'),
  url(r'^borrar_producto/$', views.borrar_producto, name='borrar_producto'),
  ...
  url(r'^modificar_perfil/$', views.modificar_perfil, name='modificar_perfil'),
