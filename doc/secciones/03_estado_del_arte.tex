...
Tras un análisis acerca de aplicaciones cuya principal función sea la generación de dietas encontré \textbf{Intake24} \cite{Intake24} y \textbf{Eatthismuch} \cite{Eatthismuch}. 
\\\\
